...
// duración del vuelo VISUAL de la bala del francotirador (puro teatro; el daño en el
// sim ya se aplicó al instante). Súbelo si quieres una bala más "con peso".
const SNIPER_BULLET_MS = 500;
